...
(function() {
  ...
  $.widget("ui.areacomplete", $.ui.autocomplete, {
    ...
    search: function(value, event) {
      ...
      if (!value) {
        ...
        //.log(match.index , match[0].length, match[1])
    ...
    _renderItem: function(ul, item) {
      ...
      if (item.image) {
        anchor.append("<img class='profile' src=\"" + item.image + "\" />");
      }
  ...
  MentionsContenteditable = (function(_super) {
    ...
    mentionTpl = function(mention) {
      //return "<strong data-mention=\"" + mention.uid + "\"><img" + mention.value + "</strong>";
      return `<strong data-mention="${mention.uid}"><img src="${mention.img}" height="64px">${mention.value}</strong> `
    };
